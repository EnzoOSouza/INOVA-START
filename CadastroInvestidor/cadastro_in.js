...
document.getElementById("telefone_pf").addEventListener("input", function() {
...
document.getElementById("telefone_pj").addEventListener("input", function() {
    // Remove caracteres não numéricos ao inserir no campo
    this.value = this.value.replace(/\D/g, '');
    // Chama a função para formatar o número
    formatPhoneNumber(this);
...
document.getElementById("cpf_pf").addEventListener("input", function() {
    // Remove caracteres não numéricos ao inserir no campo
...
function validarEmail(emailFieldId) {
    const emailField = document.getElementById(email_pf);
    const emailValue = emailField.value;
